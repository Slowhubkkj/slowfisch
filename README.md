 getgenv().hub then warn("slow hub|fisch : Already executed!") return end
getgenv().hub = true
...
if DeviceType == "Mobile" then
    ...
    ImageLabel.Image = "rbxassetid://120044865180067" -- add image here
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | slow hub | fisch - Premium",
    SubTitle = " (https://discord.gg/AWHeW8am28)", -- discord link
    TabWidth = 160,
